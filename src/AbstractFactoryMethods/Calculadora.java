...
public class Calculadora extends JPanel {
    ...
    private void btn_Convertor(String opcion){
        getFieldsText(operacion.CONVERSION);
        factory =FactoryProducer.getFactory(operacion.CONVERSION);
        try {
            String total;
            total = factory.getconvercionDecimalBinario(opcion).convercionDecimalBinario(num);
